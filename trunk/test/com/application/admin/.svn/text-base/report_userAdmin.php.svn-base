...
class report_useradmin extends Admin{
	...
	function home(){
		...
		$this->View->assign("paging",$this->Paging->getAdminPaging($start, $total_per_page, $total, "?s=report_useradmin&search={$search}&startdate={$startdate}&enddate={$enddate}"));	
