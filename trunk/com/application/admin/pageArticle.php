...
class pageArticle extends Admin{
	var $category;
	var $type;
	function __construct(){	
		parent::__construct();	
		
		$this->type = "1,3,4,5,6,15,7,8,9,10";
		$this->contentType = "0";
		$this->folder =  'pageArticle';
		$this->dbclass = 'athreesix';
		$this->fromwho = 2; // 0 is admin/backend
	...
	function getTypeList(){
		$sql = "SELECT * FROM {$this->dbclass}_news_content_type WHERE id IN ({$this->type}) ";
