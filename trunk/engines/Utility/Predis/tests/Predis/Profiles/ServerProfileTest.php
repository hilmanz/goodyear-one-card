...
use Predis\Commands\Processors\ProcessorChain;
...
class ServerProfileTest extends StandardTestCase
{
    ...
    public function testGetDefault()
    {
        ...
        $this->assertInstanceOf('Predis\Profiles\IServerProfile', $profile1);
        $this->assertInstanceOf('Predis\Profiles\IServerProfile', $profile2);
        $this->assertInstanceOf('Predis\Profiles\IServerProfile', $profile3);
    ...
    {
        $profileClass = get_class($this->getMock('Predis\Profiles\IServerProfile'));
    ...
    public function testGetCommandClass()
    {
        ...
        $this->assertSame('Predis\Commands\ConnectionPing', $profile->getCommandClass('ping'));
        $this->assertSame('Predis\Commands\ConnectionPing', $profile->getCommandClass('PING'));
    ...
    public function testSingleProcessor()
    {
        ...
        $processor->expects($this->once())
                  ->method('process')
                  ->with($this->isInstanceOf('Predis\Commands\ICommand'))
