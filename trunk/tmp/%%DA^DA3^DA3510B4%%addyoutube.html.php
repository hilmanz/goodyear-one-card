<?php /* Smarty version 2.6.13, created on 2015-08-21 10:32:29
         compiled from application/admin//apps/addyoutube.html */ ?>
<?php echo '
<script>
	tinyMCE.init({
...
" class="title"  ><br>
						...
						<div class="row">
							<label for="title">Video <br></label>
							<input id="url" name="url" type="text" value="<?php echo $this->_tpl_vars['url']; ?>
" class="video" placeholder="Url Video Youtube"><br>							                        	
