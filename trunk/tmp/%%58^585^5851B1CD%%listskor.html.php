<?php /* Smarty version 2.6.13, created on 2015-11-10 22:03:36
			  ...
			  <form method="GET" action="" id="shorter">
             	...
             	<div class="skorShorter">
                     <div class="skorEach" id="">
                        <span class="fl">Skor 1 :</span>
                        <div class="skorRow fl">
                            <input type="text" value="" name="skor1" class="skorInput" id="">
                        </div><!-- /.rows -->
                        
                        <span class="fl">Vs</span>
                        <div class="skorRow fl">
                            <input type="text"  value="" name="skor2" class="skorInput" id="">
                        </div><!-- /.rows -->
                    </div>

                    <div class="skorEach" id="">
                        <span class="fl">Skor 2 :</span>
                        <div class="skorRow fl">
                            <input type="text" value="" name="skor3" class="skorInput" id="">
                        </div><!-- /.rows -->
                        
                        <span class="fl">Vs</span>
                        <div class="skorRow fl">
                            <input type="text"  value="" name="skor4" class="skorInput" id="">
                        </div><!-- /.rows -->
                    </div>

                    <div class="skorEach" id="">
                        <span class="fl">Skor 3 :</span>
                        <div class="skorRow fl">
                            <input type="text" value="" name="skor5" class="skorInput" id="">
                        </div><!-- /.rows -->
                        
                        <span class="fl">Vs</span>
                        <div class="skorRow fl">
                            <input type="text"  value="" name="skor6" class="skorInput" id="">
                        </div><!-- /.rows -->
                        <input type="submit" class="button2" style="margin-top:0px; margin-bottom: 0; margin-left: 20px;" value="Go">
                    </div>
...
$this->_sections['i']['loop'] = is_array($_loop=$this->_tpl_vars['pertandingan1']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
						<th class="head0"><?php echo $this->_tpl_vars['pertandingan1'][$this->_sections['i']['index']]['club1']; ?>
 vs <?php echo $this->_tpl_vars['pertandingan1'][$this->_sections['i']['index']]['club2']; ?>
</th>
					<?php endfor; endif; ?>
					<?php unset($this->_sections['i']);
$this->_sections['i']['name'] = 'i';
$this->_sections['i']['loop'] = is_array($_loop=$this->_tpl_vars['pertandingan2']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
$this->_sections['i']['show'] = true;
$this->_sections['i']['max'] = $this->_sections['i']['loop'];
$this->_sections['i']['step'] = 1;
$this->_sections['i']['start'] = $this->_sections['i']['step'] > 0 ? 0 : $this->_sections['i']['loop']-1;
...
$this->_sections['i']['last']       = ($this->_sections['i']['iteration'] == $this->_sections['i']['total']);
?>
						<th class="head0"><?php echo $this->_tpl_vars['pertandingan2'][$this->_sections['i']['index']]['club1']; ?>
 vs <?php echo $this->_tpl_vars['pertandingan2'][$this->_sections['i']['index']]['club2']; ?>
</th>
					<?php endfor; endif; ?>
					<?php unset($this->_sections['i']);
$this->_sections['i']['name'] = 'i';
$this->_sections['i']['loop'] = is_array($_loop=$this->_tpl_vars['pertandingan3']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
$this->_sections['i']['show'] = true;
$this->_sections['i']['max'] = $this->_sections['i']['loop'];
$this->_sections['i']['step'] = 1;
$this->_sections['i']['start'] = $this->_sections['i']['step'] > 0 ? 0 : $this->_sections['i']['loop']-1;
...
$this->_sections['i']['last']       = ($this->_sections['i']['iteration'] == $this->_sections['i']['total']);
?>
						<th class="head0"><?php echo $this->_tpl_vars['pertandingan3'][$this->_sections['i']['index']]['club1']; ?>
 vs <?php echo $this->_tpl_vars['pertandingan3'][$this->_sections['i']['index']]['club2']; ?>
</th>
					<?php endfor; endif; ?>										
...
?>
 ...
 - <?php echo $this->_tpl_vars['list'][$this->_sections['i']['index']]['skor2']; ?>
						...
						<td class="center"><?php echo $this->_tpl_vars['skor2'][$this->_sections['i']['index']]['skor1']; ?>
 - <?php echo $this->_tpl_vars['skor2'][$this->_sections['i']['index']]['skor2']; ?>
</td>
						<?php elseif ($this->_tpl_vars['list'][$this->_sections['i']['index']]['sekor3'] == $this->_tpl_vars['skor2'][$this->_sections['i']['index']]['skor1'] && $this->_tpl_vars['list'][$this->_sections['i']['index']]['sekor4'] == $this->_tpl_vars['skor2'][$this->_sections['i']['index']]['skor2']): ?>
						<td class="center"><span class="trueA icon-checkmark">&nbsp;</span></td>
						<?php elseif ($this->_tpl_vars['list'][$this->_sections['i']['index']]['sekor3'] != $this->_tpl_vars['skor2'][$this->_sections['i']['index']]['skor1'] && $this->_tpl_vars['list'][$this->_sections['i']['index']]['sekor4'] != $this->_tpl_vars['skor2'][$this->_sections['i']['index']]['skor2']): ?>
						<td class="center"><span class="wrongA">X</span></td>
						<?php elseif ($this->_tpl_vars['list'][$this->_sections['i']['index']]['sekor3'] != $this->_tpl_vars['skor2'][$this->_sections['i']['index']]['skor1'] && $this->_tpl_vars['list'][$this->_sections['i']['index']]['sekor4'] == $this->_tpl_vars['skor2'][$this->_sections['i']['index']]['skor2']): ?>
						...
						<td class="center"><?php echo $this->_tpl_vars['skor3'][$this->_sections['i']['index']]['skor1']; ?>
 - <?php echo $this->_tpl_vars['skor3'][$this->_sections['i']['index']]['skor2']; ?>
</td>
						<?php elseif ($this->_tpl_vars['list'][$this->_sections['i']['index']]['sekor5'] == $this->_tpl_vars['skor3'][$this->_sections['i']['index']]['skor1'] && $this->_tpl_vars['list'][$this->_sections['i']['index']]['sekor6'] == $this->_tpl_vars['skor3'][$this->_sections['i']['index']]['skor2']): ?>
						<td class="center"><span class="trueA icon-checkmark">&nbsp;</span></td>
						<?php elseif ($this->_tpl_vars['list'][$this->_sections['i']['index']]['sekor5'] != $this->_tpl_vars['skor3'][$this->_sections['i']['index']]['skor1'] && $this->_tpl_vars['list'][$this->_sections['i']['index']]['sekor6'] != $this->_tpl_vars['skor3'][$this->_sections['i']['index']]['skor2']): ?>
						<td class="center"><span class="wrongA">X</span></td>
						<?php elseif ($this->_tpl_vars['list'][$this->_sections['i']['index']]['sekor5'] != $this->_tpl_vars['skor3'][$this->_sections['i']['index']]['skor1'] && $this->_tpl_vars['list'][$this->_sections['i']['index']]['sekor6'] == $this->_tpl_vars['skor3'][$this->_sections['i']['index']]['skor2']): ?>
 ...
 - <?php echo $this->_tpl_vars['skor3'][$this->_sections['i']['index']]['skor2']; ?>
						...
						<td><?php echo $this->_tpl_vars['list'][$this->_sections['i']['index']]['tgl']; ?>
</td>
						
						<td>
							<?php if (( $this->_tpl_vars['list'][$this->_sections['i']['index']]['sekor1'] == $this->_tpl_vars['list'][$this->_sections['i']['index']]['skor1'] && $this->_tpl_vars['list'][$this->_sections['i']['index']]['sekor2'] == $this->_tpl_vars['list'][$this->_sections['i']['index']]['skor2'] ) && ( $this->_tpl_vars['list'][$this->_sections['i']['index']]['sekor3'] == $this->_tpl_vars['skor2'][$this->_sections['i']['index']]['skor1'] && $this->_tpl_vars['list'][$this->_sections['i']['index']]['sekor4'] == $this->_tpl_vars['skor2'][$this->_sections['i']['index']]['skor2'] ) && ( $this->_tpl_vars['list'][$this->_sections['i']['index']]['sekor5'] == $this->_tpl_vars['skor3'][$this->_sections['i']['index']]['skor1'] && $this->_tpl_vars['list'][$this->_sections['i']['index']]['sekor6'] == $this->_tpl_vars['skor3'][$this->_sections['i']['index']]['skor2'] )): ?>
