<?php /* Smarty version 2.6.13, created on 2015-10-07 10:35:40
         compiled from application/web//apps/style.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'application/web//apps/style.html', 34, false),array('modifier', 'truncate', 'application/web//apps/style.html', 39, false),)), $this); ?>
...
style/detail/<?php echo $this->_tpl_vars['listcontent'][$this->_sections['i']['index']]['id']; ?>
...
?>
            <figure class="item col-md-4">
				...
				<?php if ($this->_tpl_vars['listcontentdetail'][$this->_sections['i']['index']]['img']): ?>
                	<a class="thumb thumb-medium" href="<?php echo $this->_tpl_vars['basedomain']; ?>
style/detail/<?php echo $this->_tpl_vars['listcontentdetail'][$this->_sections['i']['index']]['id']; ?>
...
','<?php echo $this->_tpl_vars['basedomain']; ?>
style/detail?param=<?php echo $this->_tpl_vars['listcontentdetail'][$this->_sections['i']['index']]['id']; ?>
','<?php echo $this->_tpl_vars['basedomain']; ?>
style/detail?param=<?php echo $this->_tpl_vars['listcontentdetail'][$this->_sections['i']['index']]['id']; ?>
