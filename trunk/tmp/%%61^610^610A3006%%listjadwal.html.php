<?php /* Smarty version 2.6.13, created on 2015-11-10 22:03:38
...
$this->_sections['i']['last']       = ($this->_sections['i']['iteration'] == $this->_sections['i']['total']);
?>
						<td><?php echo $this->_tpl_vars['pertandingan1'][$this->_sections['i']['index']]['club1']; ?>
...
$this->_sections['i']['last']       = ($this->_sections['i']['iteration'] == $this->_sections['i']['total']);
?>
						<td><?php echo $this->_tpl_vars['pertandingan2'][$this->_sections['i']['index']]['club1']; ?>
...
$this->_sections['i']['last']       = ($this->_sections['i']['iteration'] == $this->_sections['i']['total']);
?>
						<td><?php echo $this->_tpl_vars['pertandingan3'][$this->_sections['i']['index']]['club1']; ?>
 vs <?php echo $this->_tpl_vars['pertandingan3'][$this->_sections['i']['index']]['club2']; ?>
</td>
					<?php endfor; endif; ?>			
					
					<td><?php echo $this->_tpl_vars['list'][$this->_sections['i']['index']]['tgl_main']; ?>
</td>					
