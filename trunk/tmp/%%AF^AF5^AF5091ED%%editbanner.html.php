<?php /* Smarty version 2.6.13, created on 2015-08-18 16:04:32
         compiled from application/admin//apps/editbanner.html */ ?>
<?php echo '
<script>
	tinyMCE.init({
		theme : "advanced",
...
banner/editbanner" enctype="multipart/form-data">
...
public_assets/banner/<?php echo $this->_tpl_vars['listnya'][$this->_sections['i']['index']]['images']; ?>
">
					</div> 
					...
					<label for="Date">Url 	:</label></label>
						<input  name="url" type="text" value="<?php echo $this->_tpl_vars['listnya'][$this->_sections['i']['index']]['link']; ?>
" >
					</div>
