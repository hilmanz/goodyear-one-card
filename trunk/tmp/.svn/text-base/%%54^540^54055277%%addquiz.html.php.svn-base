<?php /* Smarty version 2.6.13, created on 2015-05-12 10:48:14
         compiled from application/admin//apps/addquiz.html */ ?>
<?php echo '
<script>
	tinyMCE.init({
		theme : "advanced",
...
quiz" class="button2">Back</a></h2>
        ...
        <div class="content">
            ...
            <div id="new-project" class="boxcontent">
                <section class="step1">
                    <div class="row">
                        <label for="title">Image Quiz<br>
                        	<i> *ukuran File  x  pixel</i></label>
                       <input  name="imgquiz" type="file" class="required mandatory url imgquiz" ><br>
					<label class="msg_name" style="color: red;" style="clear:both;"><?php echo $this->_tpl_vars['title_no']; ?>
</label>
                    </div><!-- end .row -->
					<div class="row">
