<?php /* Smarty version 2.6.13, created on 2015-11-10 22:16:32
         compiled from application/web/apps/puzzle2.html */ ?>
<div id="tebak-skor" class="section">
	<div id="container">
	<div class="titlebox">                      
			<h2><center><a href="#" class="button2 start">Start</a></center></h2>
			<!--<h2><center><a href="#" class="button2 stop">Stop</a></center></h2>-->
			<!--<div>Puzzle closes in <span id="time"></span> minutes!</div>-->
			<div>Time Puzzle <span id="clock"></span></div>
        </div><!-- end .titlebox -->
        <div class="rows">
 ...
 const PUZZLE_DIFFICULTY = 4;
		...
		canvas.onmousedown = function(e){
            ...
            if(e.layerX || e.layerX == 0){
                ...
                _mouse.y = e.layerY - _canvas.offsetTop+330;
				//alert(e.layerX);exit;
            }
            else if(e.offsetX || e.offsetX == 0){
                _mouse.x = e.offsetX - _canvas.offsetLeft+20;
                _mouse.y = e.offsetY - _canvas.offsetTop+330;
				alert("2");
            }
