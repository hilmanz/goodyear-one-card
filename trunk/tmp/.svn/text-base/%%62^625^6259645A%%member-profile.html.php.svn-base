<?php /* Smarty version 2.6.13, created on 2015-11-10 23:38:45
...
"><button class="button" >UBAH</button></a>
		...
		<div class="rows">
			<div class="boxLine">
				...
				<div class="vocerText">
					<p><i>Kode Voucher</i> <span class="codeVocher yellow"><?php if ($this->_tpl_vars['memberprofile']['voucer_id'] == 0): ?>Tidak Tersedia<?php else:  echo $this->_tpl_vars['memberprofile']['voucer'];  endif; ?></span></p>
				</div>
			</div>
		</div><!--end.rows-->
