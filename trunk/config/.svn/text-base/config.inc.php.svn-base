...
if(preg_match("/dev./i",$_SERVER['HTTP_HOST'])){
	$DOMAIN = "http://{$_SERVER['HTTP_HOST']}/goodyear/";
	$PUBLIC_HTML = "";
}else{
	$DOMAIN = "http://{$_SERVER['HTTP_HOST']}/goodyear/";
...
$CONFIG['BASE_DOMAIN_PATH'] = "localhost:8080/goodyear/"; //localhost
...
$CONFIG['LOCAL_PUBLIC_ASSET'] = "/home/kana/kanadigital/preview/gogirl/public_html/public_assets/";
...
$CONFIG['SESSION_NAME'] = "prodiaku-2015_apps_2015";
...
$CONFIG['DATABASE_WEB'] = "db_goodyear";
