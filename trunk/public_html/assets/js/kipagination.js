		...
		if(current>=3){
			...
			if(lastPage<3){
				...
				if(current != 1){
					...
					str+='<a class="cPaging arrowLeft" href="#p'+(current-1)+'" onClick="'+fungsi+'(\''+type+'\', '+realPage+');kiPagination('+data+','+(current-1)+',\''+divPage+'\',\''+type+'\',\''+fungsi+'\','+setPerPage+');return false;"></a>';
				}
				//paging number
				...
				for(i=0;i<maxPageShow;i++){
					...
					str+='<a id="p'+p+'" class="cPaging" href="#p'+p+'" onClick="'+fungsi+'(\''+type+'\', '+realPage+');kiPagination('+data+','+p+',\''+divPage+'\',\''+type+'\',\''+fungsi+'\','+setPerPage+');return false;"></a>';
					p++;
				}
				//next btn				
				//str+='<a class="cPaging arrowRight" href="#p'+(totalPage)+'" onClick="'+fungsi+'(\''+type+'\', '+loopendingpage+');kiPagination('+data+','+(totalPage)+',\''+divPage+'\',\''+type+'\',\''+fungsi+'\','+setPerPage+');return false;">Last</a>';
				if(current != totalPage){
					if(current == 1){var realPage = perPage;}else{var realPage = (current*perPage);}
					str+='<a class="cPaging arrowRight" href="#p'+(current+1)+'" onClick="'+fungsi+'(\''+type+'\', '+realPage+');kiPagination('+data+','+(current+1)+',\''+divPage+'\',\''+type+'\',\''+fungsi+'\','+setPerPage+');return false;"></a>';
				}				
				$("#"+divPage+"").html(str);
				
				//highlight
				$("#"+divPage+" a#p"+current+"").addClass('current');
				$("#"+divPage+" a#p"+current+"").parent().addClass('active');
			}else{
			...
			//	str+='<a class="cPaging" href="#p'+(1)+'" onClick="'+fungsi+'(\''+type+'\', '+realPage+');kiPagination('+data+','+(1)+',\''+divPage+'\',\''+type+'\',\''+fungsi+'\','+setPerPage+');return false;">First</a>';
				...
				//next btn				
				//str+='<a class="cPaging arrowRight" href="#p'+(totalPage)+'" onClick="'+fungsi+'(\''+type+'\','+loopendingpage+');kiPagination('+data+','+(totalPage)+',\''+divPage+'\',\''+type+'\',\''+fungsi+'\','+setPerPage+');return false;"></a>';
				if(current != totalPage){
					if(current == 1){var realPage = perPage;}else{var realPage = (current*perPage);}
					str+='<a class="cPaging arrowRight" href="#p'+(current+1)+'" onClick="'+fungsi+'(\''+type+'\', '+realPage+');kiPagination('+data+','+(current+1)+',\''+divPage+'\',\''+type+'\',\''+fungsi+'\','+setPerPage+');return false;"></a>';
				}			
